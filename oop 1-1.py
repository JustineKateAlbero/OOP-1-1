...
lbl2.place(x= 105, y=210, anchor ="center")
...
chkbox.place(x= 120, y= 305)
chkbox2.place(x= 120, y= 330)
chkbox3.place(x= 120, y= 355)


#Add List box

lbl4 = Label(window, text = "Subjects", fg="pink", bg="black")
lbl4.place(x= 87, y= 400)
